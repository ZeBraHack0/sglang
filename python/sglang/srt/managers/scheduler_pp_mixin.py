...
class SchedulerPPMixin:
    ...
    def _pp_prep_batch_result(
        ...
        if accept_lens is not None:
            ...
            accept_lens_cpu = accept_lens.to(
                "cpu", torch.int32, non_blocking=True
            )
    ...
    def _pp_process_batch_result(
        ...
        if spec_batch is not None and spec_batch.seq_lens_cpu is not None:
            spec_batch.seq_lens_cpu = spec_batch.seq_lens_cpu + output_result.accept_lens.to(
                spec_batch.seq_lens_cpu.dtype
            )
